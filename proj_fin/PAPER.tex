...
\author{\IEEEauthorblockN{Adia-Ioana Romanescu, Alexandru Ghiarasim, Mircea-Andrei Tomescu}
...
\textbf{TOR (Active)*} & \textbf{OK} & \textbf{18.7 ms} & \textbf{53.5 ev/s} & Strongest \\
\textbf{TOR (Inactive)} & \textbf{FAIL} & \textbf{---} & \textbf{---} & Strongest \\
\bottomrule
\end{tabular}
\end{table}
\small{*Estimated standard onion-routing circuit latency for small-packet telemetry.}
